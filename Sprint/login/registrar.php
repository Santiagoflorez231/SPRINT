...
<head>
    ...
    <style>
        .bg {
            background-image: url(/Sprint/img/fondo_lado2.jpg);
        ...
        body {
            background-image: url("/Sprint/img/diseno-de-paisaje-del-espacio_3840x2160_xtrafondos.com.jpg");
            background-position: center center;
            background-size: cover;
        ...
        <div class="row align-items-stretch">
            ...
            <div class="col pt-5 rounded m-5">
                ...
                <form action="" method="post">
                    ...
                    <div class="m-5">
                        <button type="submit" class="btn btn-primary col-12 mb-2">Acceder</button>
                    </div>
                    <div class="my-3">
                        <span class="text-white">¿No tienes cuenta? <a href="formulario.php">Iniciar Sesion</a></span>
                    </div>
                </form>
            </div>
        </div>
